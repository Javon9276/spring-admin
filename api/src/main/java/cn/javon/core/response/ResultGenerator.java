package cn.javon.core.response;
...
public class ResultGenerator {
	...
	private static final String DEFAULT_UNAUTHORIZED_MESSAGE = "权限不足";
	...
	public static Result genMethodErrorResult() {
		return new Result.Builder(HttpStatus.METHOD_NOT_ALLOWED.value()).msg(DEFAULT_METHOD_NOT_ALLOWED_MESSAGE)
				.build();
	}
